...
1.Explicity list every items related to dm9051a ptp, base on dm9051a original standard driver.
2.db->ptp_mode = (int) dm9051_ptp_one_step(skb), The usage of db->ptp_mode could be 
   changed by use db->ptp_packet, db->ptp_sync, and db->ptp_step instead.
